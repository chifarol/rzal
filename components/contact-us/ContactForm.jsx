    ...
    axios.post("/api/contact",
      ...
      .then((res) => {
        ...
        if (res.data.emailStatus) {
          setEmailMsg({ text: "Your message was submitted successfully", success: true });
          window.location.hash = "hire-contact-form"
        } else {
          setEmailMsg({ text: "Your message could not be sent please try again later.", success: false });
        }
      })
      .catch((err) => {
